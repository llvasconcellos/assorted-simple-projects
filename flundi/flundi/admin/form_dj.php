...
<table align="center" class="tabela" cols="2">
  <form name="form1" method="post" action="salvadj.php">
    ...
    <tr> 
      <td class="label">Comentarios<br><br><br><br><br><br><br><br><br><br><br><br><br><br><div style="cursor: pointer" onclick="javascript: window.open('http://www.detetivez.hpg.ig.com.br/tutoriais/html/fotehtml.htm')">Formatação de texto</div><div style="cursor: pointer" onclick="javascript: window.open('http://www.detetivez.hpg.ig.com.br/tutoriais/html/espehtml.htm')">Caracteres Especiais</div></td>
      <td class="cell">
	  	<?php if ($metodo == "add") {?>
